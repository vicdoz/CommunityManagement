...
public class ReportPropietarios {
	...
	public void muestraTodos() {
		...
		try {
			String fileName= "src/reports/listados/Propietarios.jasper";
	...
	public void muestraPorPropietario(int id) {
		...
		try {
			String fileName= "src/reports/listados/InmueblesPorPropietario.jasper";
			System.out.println("Fichero encontrado!");
			 informe= JasperFillManager.fillReport(fileName, parametros);
